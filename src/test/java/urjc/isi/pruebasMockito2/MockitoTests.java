package urjc.isi.pruebasMockito2;
...
public class MockitoTests {
	...
	public void MockListSize() {
		List list = mock(List.class);		//Crea un suplantador de clase list, no una list de verdad
	...
	public void MockListSizeWithMultipleReturnValues() {
		...
		verify(list, times(3)).size(); // Verifica que se ha llamado 
									   // 3 veces al método size de list
	}
